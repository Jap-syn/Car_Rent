              ...
              <div class="row mb-5">
                <div class="col-md-12">
                    <div class="border w-100 p-4 rounded mb-2 d-flex">
                      ...
                      <p><span>Address:</span>No.130, Ye Yan Naing Street, 36 wards, Northdagon Township, Yangon. </p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="border w-100 p-4 rounded mb-2 d-flex">
                      ...
                      <p><span>Phone:</span> <a href="tel://1234567920">+ 959250676233</a></p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="border w-100 p-4 rounded mb-2 d-flex">
                      ...
                      <p><span>Email:</span> <a href="mailto:info@yoursite.com">sithunyuntswe1@gmail.com</a></p>
                    </div>
                </div>
              </div>
        </div>
