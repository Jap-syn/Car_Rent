      ...
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="col-md-12">
          <div class="card" style="box-shadow:2px 2px 2px 2px lightblue;">
            <br>  
            <form action="/registration/update/{{ isset($registration)? $registration->id:0 }}" method="post"  enctype="multipart/form-data">
                 <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
               

            <div class="form-group">
              <div class="col-md-10 offset-1">
              <select class="form-control" name="collect_type">
                  
                <option selected disabled>Please choose your collection type</option>
                <option value="1">Collect by myself (no additional charges)</option>
                <option value="2">Deliver to me (no additional fees)</option>
              ...
              <input type="submit" onclick="return myFunction();" value="Confirm" class="btn btn-warning py-3 px-5">
            </div>
              </div>
