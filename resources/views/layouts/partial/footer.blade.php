      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            <a href="javascript:void(0)" target="_blank">Si Thu Nyunt Swe</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
  ...
  <script src="/backend/assets/js/black-dashboard.min.js?v=1.0.0"></script><!-- Black Dashboard DEMO methods, don't include it in your project! -->
