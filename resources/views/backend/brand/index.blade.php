        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <div class="col-md-12">
                    <a href="/backend/brand/create" class="form-control btn btn-info" type="button" id="btn_new" name="btn_new"> <i class="tim-icons icon-simple-add">New Brand</i></a>
                </div>
                        ...
                        <th style="text-align:center;">Action</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a class="btn btn-info" onclick="return myFunction();" href='/backend/brand/{{ $obj->id }}/edit'> <i class="tim-icons icon-pencil"></i> Edit</a></td>
                                        <td style="text-align:center;">
                                            <form action="{{ url('/backend/brand', ['id' => $obj->id]) }}" method="post">
